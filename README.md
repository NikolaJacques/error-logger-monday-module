...
- Modules
    ...
    3. The webhook module (part of back end or core module)
    4. Shared types
...
- displays error log information in different ways (front end module, Power BI...)
...
- retrieving and displaying the data in Power BI
