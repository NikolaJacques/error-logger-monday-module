...
exports.queryAPI = exports.createBugQuery = exports.getBugsQuery = void 0;
const axios_1 = __importDefault(require("axios"));
const env_1 = require("./env");
const getBugsQuery = (name) => {
    return {
        query: `
            query ($stack: String!) {
...
exports.getBugsQuery = getBugsQuery;
...
const queryAPI = (body) => __awaiter(void 0, void 0, void 0, function* () {
    try {
